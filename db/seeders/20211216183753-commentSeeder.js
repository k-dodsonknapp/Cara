...
module.exports = {
  up: (queryInterface, Sequelize) => {
    ...
    return queryInterface.bulkInsert('Comments', [
      {
        body: "I’ll start. My first car I ever drove was my dad’s 11 CTS-V automatic. I wasn’t into cars at all at the time, thought it was old car. Had no idea I was in a fancy corvette with 500 hp to the rear wheels. Now I know what it is and I still can’t believe that’s what he decided to let a 16 year old learn to drive in",
        userId: 3,
        answersId: 10,
        createdAt: new Date(),
        updatedAt: new Date(),
      ...
      {
        body: "Plenty of people do it on those roads but that's not a justification. I personally think what he does is slightly worse just because there is a profit incentive in it for him instead of just going out for fun. If he does ever run over a cyclist on a blind corner, it is going to be a nightmare of a defense for his attorneys.",
        userId: 2,
        answersId: 9,
        createdAt: new Date(),
        updatedAt: new Date(),
      ...
      {
        body: "The Audi Q5 on a little offroad trail. Has no trouble finding grip in sandy conditions, not sure how I know that though...",
        userId: 2,
        answersId: 15,
        createdAt: new Date(),
        updatedAt: new Date(),
